...
class JobStatusPoller(Timer):
    def __init__(self, *, strategy: Optional[str], policy_file: Optional[str], evolving_requests_file: Optional[str], max_idletime: float,
                 strategy_period: Union[float, int]) -> None:
        self._executors = []  # type: List[BlockProviderExecutor]
        self._strategy = Strategy(strategy=strategy,
                                  policy_file=policy_file,
                                  evolving_requests_file=evolving_requests_file,
